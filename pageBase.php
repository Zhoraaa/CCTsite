<?php
// Два запроса на подключение баз, первый для процесса разработки, второй для бд на хосте
...
if (isset($_COOKIE['user'])) {
    ...
    $userInfo = mysqli_fetch_assoc($cctdb->query("SELECT * FROM users WHERE id=" . $_COOKIE['user']));
